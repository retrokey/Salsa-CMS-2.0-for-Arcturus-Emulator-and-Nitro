...
<head>
    ...
    <?php
    $titulo = "Give promotion points to a user";
    $desc = "This function allows you to award promotion points to a user.";
    ?>
  ...
  <div class="row">
    ...
    <div class="col-sm-12">
         <?php SalsaPainel::dar_pontospromocao($conn) ?>
                                <form method="post">
                                    <label>Name of the user who will receive 1 (one) point:</label>
                                    <br>
