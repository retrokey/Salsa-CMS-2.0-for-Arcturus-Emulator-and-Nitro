...
<head>
    ...
    <?php
    $titulo = "Dar pontos de promoção para um usuário";
    $desc = "Essa função permite você de pontos de promoção para um usuário.";
    ?>
...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
  ...
  <div class="row">
    ...
    <div class="col-sm-12">
         <?php SalsaPainel::dar_pontospromocao($conn) ?>
                                <form method="post">
                                    <label>Nome do usuário que receberá 1 (um) ponto:</label>
                                    <br>
