...
<head>
    ...
    <?php
    $titulo = "Give badges to a user";
    $desc = "This function allows you to give badges to a user even if he is offline.";
    ?>
  ...
  <div class="row">
    ...
    <div class="col-sm-12">
         <?php SalsaPainel::dar_emblema($conn) ?>
                                <form method="post">
                                    <label>Name of the user who will receive the badge:</label>
                                    <br>
