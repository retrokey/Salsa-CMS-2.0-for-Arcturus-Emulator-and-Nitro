...
<head>
    ...
    <?php
    $titulo = "Dar emblemas para um usuário";
    $desc = "Essa função permite você dê emblemas para um usuário mesmo que ele esteja offline.";
    ?>
...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
  ...
  <div class="row">
    ...
    <div class="col-sm-12">
         <?php SalsaPainel::dar_emblema($conn) ?>
                                <form method="post">
                                    <label>Nome do usuário que receberá o emblema:</label>
                                    <br>
